      ...
      ?>
        ...
        <tr>
          ...
          <td><?php echo $rows2;  ?></td>
           <td><a href="includes/php/det_serv_client.php?cod_cliente=<?php echo $datos['cod_cliente']; ?>&cod_resp=<?php echo $cod_resp; ?>" tittle='Revisar' class="edicion"><img src='img/edit.png' width="24" height="24"></a></td>       </tr>
             </tr>
        </td>
